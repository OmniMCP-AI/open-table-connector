...
_EXPECTED_METADATA = {
    ...
    "local_files": _ExpectedConnectorMetadata(
        ...
        capabilities=(
            ...
            ("table.read.arrow", "1.0"),
            ("table.read.polars", "1.0"),
            ("spreadsheet.workbook.inspect", "1.0"),
            ("spreadsheet.workbook.write", "1.0"),
            ("spreadsheet.workbook.verify", "1.0"),
            ("spreadsheet.worksheet.list", "1.0"),
            ("spreadsheet.worksheet.create", "1.0"),
            ("spreadsheet.worksheet.rename", "1.0"),
            ("spreadsheet.worksheet.delete", "1.0"),
            ("spreadsheet.worksheet.move", "1.0"),
            ("spreadsheet.range.read", "1.0"),
            ("spreadsheet.range.write", "1.0"),
            ("spreadsheet.range.clear", "1.0"),
            ("spreadsheet.range.sort", "1.0"),
            ("spreadsheet.range.style", "1.0"),
            ("spreadsheet.range.format", "1.0"),

...
def assert_capabilities_are_unique(
    ...
    *,
    ...
    if manifest is not None:
        ...
        expected_manifest_keys = {"connector", "capabilities", "modes", "uri_schemes"}
        if manifest.managed_io:
            expected_manifest_keys.add("managed_io")
        _assert_closed_wire(wire, expected_manifest_keys, "CapabilityManifest")

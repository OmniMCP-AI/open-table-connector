...
def test_grouped_fixed_aggregates_have_explicit_null_semantics() -> None:
...
def test_first_last_aggregates_require_duplicate_resolution() -> None:
    source = MemoryTemporalSource(temporal_descriptor=descriptor(DuplicatePolicy.PRESERVE))
    with pytest.raises(TemporalExtensionError, match="duplicate resolution"):
        execute(
            source,
            aggregate(
                FixedBucket(600_000_000_000, "2026-08-29T00:00:00.000000000Z", 0),

...
This enhancement introduces no new Excel URI scheme. Local workbook targets
use `file://`; new examples and emitted local workbook targets use `file://`. Worksheet selection
